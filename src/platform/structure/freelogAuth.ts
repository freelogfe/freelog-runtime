...
// async function postContract(query: any): Promise<any> {
//   return frequest(contract.contracts, [], {
//     ...query,
//   });
// }
// async function getContracts(query: any): Promise<any> {
//   return frequest(contract.getContracts, [], {
//     ...query,
//   });
// }
// async function getTransitionRecords(
//   contractId: string,
//   query: any
// ): Promise<any> {
//   return frequest(contract.getTransitionRecords, [contractId], {
//     ...query,
//   });
// }
// async function getAccount(userId: string, query: any): Promise<any> {
//   return frequest(user.getAccount, [userId], {
//     ...query,
//   });
// }
