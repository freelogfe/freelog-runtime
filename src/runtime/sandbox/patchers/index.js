...
export function patchAtMounting(appName, elementGetter, sandbox, scopedCSS, excludeAssetFilter) {
    ...
    var patchersInSandbox = (_patchersInSandbox = {}, _defineProperty(_patchersInSandbox, 'Proxy', [].concat(basePatchers, [function() {
...
export function patchAtBootstrapping(appName, elementGetter, sandbox, scopedCSS, excludeAssetFilter) {
    ...
    var patchersInSandbox = (_patchersInSandbox2 = {}, _defineProperty(_patchersInSandbox2, 'Proxy', [function() {
