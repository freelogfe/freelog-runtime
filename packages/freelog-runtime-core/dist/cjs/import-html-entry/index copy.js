...
// src/import-html-entry/index copy.js
...
var import_utils2 = require("../../freelog/structure/utils");
var styleCache = {};
var scriptCache = {};
var embedHTMLCache = {};
if (!window.fetch) {
...
var defaultFetch = import_utils2.freelogFetch.bind(window);
...
function getEmbedHTML(template, styles, opts = {}, baseURI) {
  ...
  const content = (0, import_utils2.getViewport)();
