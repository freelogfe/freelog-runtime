...
function clearRouteStateFromURL(appName, url, microLocation, keepRouteState) {
    ...
    if (!keepRouteState && !isRouterModeCustom(appName)) {
        const { pathname, search, hash } = createURL(url.split('.com')[0] + '.com');
...
class WithSandBox extends BaseSandbox {
    constructor(appName, url) {
        ...
        this.patchWith((resolve) => {
            ...
            this.patchRouter(appName, url.split('.com')[0] + '.com', this.microAppWindow);
            // patch window of child app
...
class IframeSandbox {
    constructor(appName, url) {
        ...
        this.patchIframe(this.microAppWindow, (resolve) => {
            ...
            this.proxyLocation = patchRouter(appName, url.split('.com')[0] + '.com', this.microAppWindow, browserHost);
            // patch window of child app
