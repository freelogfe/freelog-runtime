...
test('should add attribute selector correctly', () => {
  ...
  const expectValue =
    'div[data-freelog="react15"] .react15-main {display: flex; flex-direction: column; align-items: center;}';

  const styleNode = fakeStyleNode(actualValue);
  CSSProcessor.process(styleNode, 'div[data-freelog="react15"]');
...
test('should replace html correctly', () => {
  ...
  const expectValue = 'div[data-freelog="react15"] {font-size: 14px;}';
...
test('should replace :root correctly [1]', () => {
  ...
  const expectValue = 'div[data-freelog="react15"] {--gray: #eee;}';
...
test('should replace :root correctly [2]', () => {
  ...
  const expectValue = `svg:not(div[data-freelog="react15"]){overflow:hidden;}`;
...
test('should rewrite root-level correctly [1]', () => {
  ...
  const expectValue = 'div[data-freelog="react15"] + div {font-size: 14px;}';
...
html [type="button"] {
  ...
  const expectValue = `div[data-freelog="react15"] [type="reset"],
div[data-freelog="react15"] [type="submit"],
div[data-freelog="react15"] button,
div[data-freelog="react15"] [type="button"] {-webkit-appearance: button;}`;
...
test('should not replace body/html if body is part of class [1]', () => {
  ...
  const expectValue = 'div[data-freelog="react15"] .ant-card-body {color: #eee;}';
...
test('should not replace body/html if body is part of class [2]', () => {
  ...
  const expectValue = 'div[data-freelog="react15"] .ant-card_body {color: #eee;}';
...
test('should not replace body/html if body is part of class [3]', () => {
  ...
  const expectValue = 'div[data-freelog="react15"] .body {color: #eee;}';
...
test('should not replace body/html if body is part of id [3]', () => {
  ...
  const expectValue = 'div[data-freelog="react15"] #ant-card__body {color: #eee;}';
...
test('should handle root-level descendant selector [1]', () => {
  ...
  const expectValue = 'div[data-freelog="react15"] {color: #eee;}';
...
test('should handle root-level grouping selector [2]', () => {
  ...
  const expectValue = 'div[data-freelog="react15"],div[data-freelog="react15"]div{color:#eee;}';
...
test('should handle root-level grouping selector [3]', () => {
  ...
  const expectValue =
    'div[data-freelog="react15"]a,div[data-freelog="react15"],div[data-freelog="react15"]div{color:#eee;}';
...
test('should not remove special root-level selector when rule is non-standard [1]', () => {
  const actualValue = 'html + body {color: #eee;}';
  const expectValue = 'div[data-freelog="react15"] + div[data-freelog="react15"] {color: #eee;}';
...
test('should transform @supports', () => {
  ...
  const expectValue = '@supports (display: grid) {div[data-freelog="react15"] div {margin: 1cm;}}';
...
test('should not transform style that has already been transform [1]', async () => {
  ...
  const expectValue = 'div[data-freelog="react15"] .react15-main {display: flex;}';
...
test.skip('should transform @media', () => {
  ...
  const expectValue = '@media screen and (max-width: 300px) {div[data-freelog="react15"] div {margin: 1cm;}}';
